...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PosDevice'
        db.create_table(u'OpenOrderUpCore_posdevice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('restaurant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['OpenOrderUpCore.Restaurant'])),
        ))
        db.send_create_signal(u'OpenOrderUpCore', ['PosDevice'])


    def backwards(self, orm):
        # Deleting model 'PosDevice'
        db.delete_table(u'OpenOrderUpCore_posdevice')
