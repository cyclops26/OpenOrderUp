...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Restaurant.fancy_name'
        db.add_column(u'OpenOrderUpCore_restaurant', 'fancy_name',
                      self.gf('django.db.models.fields.CharField')(default='TEST', max_length=250),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Restaurant.fancy_name'
        db.delete_column(u'OpenOrderUpCore_restaurant', 'fancy_name')


    models = {
        u'OpenOrderUpCore.order': {
            ...
            'restaurant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['OpenOrderUpCore.Restaurant']"})
        },
        u'OpenOrderUpCore.orderplugin': {
            'Meta': {'object_name': 'OrderPlugin', '_ormbases': ['cms.CMSPlugin']},
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'restaurant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['OpenOrderUpCore.Restaurant']"})
        },
        u'OpenOrderUpCore.posdevice': {
            'Meta': {'object_name': 'PosDevice'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            'restaurant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['OpenOrderUpCore.Restaurant']"})
        },
        u'OpenOrderUpCore.restaurant': {
            'Meta': {'ordering': "('name',)", 'object_name': 'Restaurant'},
            'fancy_name': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
        ...
        u'OpenOrderUpCore.schedule': {
            'Meta': {'ordering': "['restaurant', 'weekday', 'from_hour']", 'object_name': 'Schedule'},
        ...
        u'OpenOrderUpCore.themefooterplugin': {
            'Meta': {'object_name': 'ThemeFooterPlugin', '_ormbases': ['cms.CMSPlugin']},
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'theme': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['OpenOrderUpCore.Theme']"})
        },
        u'OpenOrderUpCore.themeheaderplugin': {
            'Meta': {'object_name': 'ThemeHeaderPlugin', '_ormbases': ['cms.CMSPlugin']},
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'theme': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['OpenOrderUpCore.Theme']"})
        },
        u'OpenOrderUpCore.themeleftplugin': {
            'Meta': {'object_name': 'ThemeLeftPlugin', '_ormbases': ['cms.CMSPlugin']},
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'theme': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['OpenOrderUpCore.Theme']"})
        },
        u'OpenOrderUpCore.themerightplugin': {
