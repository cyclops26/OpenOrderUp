...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Restaurant.short_name'
        db.add_column(u'OpenOrderUpCore_restaurant', 'short_name',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Restaurant.short_name'
        db.delete_column(u'OpenOrderUpCore_restaurant', 'short_name')
